...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    popupView.frame = CGRectMake(0, 0, ([UIScreen mainScreen].bounds.size.width), ([[UIScreen mainScreen] bounds].size.height));
...
//    NSLog(@" Main %f %f", ([UIScreen mainScreen].bounds.size.width), ([[UIScreen mainScreen] bounds].size.height));
//    NSLog(@"sourceView %f %f", (sourceView.bounds.size.width), ([sourceView bounds].size.height));
//    NSLog(@"overlayView %f %f", (overlayView.bounds.size.width), ([overlayView bounds].size.height));
//     NSLog(@"mj_popupBackgroundView %f %f", (self.mj_popupBackgroundView.bounds.size.width), ([self.mj_popupBackgroundView bounds].size.height));
//    NSLog(@"popupView %f %f", (popupView.bounds.size.width), ([popupView bounds].size.height));
